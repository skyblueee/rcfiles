...
set(IPP_ROOT $ENV{IPPROOT} CACHE PATH "Folder contains IPP")
...
if(WIN32)
    file(TO_CMAKE_PATH $ENV{IPPROOT}/bin/intel64 IPP_DLL_PATH)
    install(FILES ${IPP_DLL_PATH}/ipps-9.0.dll DESTINATION bin)
    install(FILES ${IPP_DLL_PATH}/ippcore-9.0.dll DESTINATION bin)
    install(FILES ${IPP_DLL_PATH}/ippse9-9.0.dll DESTINATION bin)
endif(WIN32)
